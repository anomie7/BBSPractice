...
<body>
    ...
    <div class="container">
        ...
        <thead>
            ...
            <tbody>
                <tr>
                    <td><input type="text" name="bbsTitle" class="form-control" maxlength="50" value="<%=bbs.getBbsTitle() %>" >
                    </td>
                </tr>
                <tr>
                    <td>
                    <textarea name="bbsContent" class="form-control" placeholder="글 내용" maxlength="2048" style="height: 350px;">
                     <%=bbs.getBbsContent()%>
                    </textarea>
                    </td>
                </tr>
